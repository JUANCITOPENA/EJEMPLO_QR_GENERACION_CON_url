...
const codigosYEnlaces = [
    ...
    { codigo: "ADVT-C-0010-2001024", enlace: "https://res.cloudinary.com/jpvtutoriales/image/upload/v1705891324/CERTIFICADO_DE_Jeuris_De_Los_Santos_Pe%C3%B1a.png" },
...
function generarCodigosQR() {
    ...
    codigosYEnlaces.forEach(({ codigo, enlace }) => {
        ...
        const textoQR = "CERTIFICADO DE " + decodeURIComponent(enlace.split('/').pop().split('_').slice(1).join('_')).replace('.png', '');
        ...
        // Crear un párrafo con el nombre y agregarlo al contenedor QR
        const nombreElement = document.createElement("p");
        nombreElement.textContent = textoQR;
        qrContainer.appendChild(nombreElement);
